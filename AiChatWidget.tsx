...
\`\`\``;
  ...
  return (
    <>
      {/* Add this style block for global mobile fullscreen */}
      <style jsx global>{`
      ...
      >
        ...
        <div
          ...
          className={`
            ...
            /* Mobile Fullscreen - using !important to override */
            sm:w-[380px] sm:h-[650px] sm:rounded-2xl
            max-sm:!fixed max-sm:!inset-0 max-sm:!w-screen max-sm:!h-screen max-sm:!rounded-none max-sm:!max-w-none max-sm:!max-h-none
