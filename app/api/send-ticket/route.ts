...
export async function POST(request: Request) {
  try {
    const { subject, priority, description, userEmail, userName } = await request.json();
            ...
            <div class="content">
              ...
              <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #e2e8f0;">
                <div style="display: flex; gap: 20px; justify-content: center;">
                  <span style="font-size: 10px; color: #64748b;">Reply to this email to respond to the customer</span>
                </div>
              </div>
            </div>
            <div class="footer">
              <p>© 2024 Support System • This is an automated message</p>
            </div>
          </div>
        </body>
        </html>
