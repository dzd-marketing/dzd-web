        ...
        <div className="hidden lg:flex lg:w-5/12 bg-gradient-to-br from-[#020617] via-[#050b1a] to-[#0a1121] border-r border-white/5 flex-col p-16 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col h-full justify-center">
            <div className="flex items-center gap-2 mb-14">
              ...
              <span className="text-2xl font-black text-white uppercase tracking-tighter">DzD <span className="text-blue-500">Empire</span></span>
            </div>
            ...
            <div className="mt-20 pt-10 border-t border-white/5">
                <p className="text-[9px] font-black text-slate-600 uppercase tracking-[0.3em]">Access Node Protocol v4.2</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex-1 bg-[#050b1a] p-8 md:p-16 lg:p-20 flex flex-col justify-center">
          <div className="max-w-md w-full mx-auto">
            ...
            <div className="mb-10 text-center lg:text-left">
              <h2 className="text-4xl font-black text-white mb-2 tracking-tighter">Login Node</h2>
              <p className="text-slate-500 font-bold uppercase tracking-[0.2em] text-[10px]">Verify Security Credentials</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center px-1">
                  ...
                  <button type="button" onClick={handleRestoreClick} className="text-[10px] font-black text-blue-500 hover:text-blue-400 uppercase tracking-widest">Restore</button>
                </div>
                <div className="relative group">
              ...
              <button type="submit" disabled={loading} className="w-full bg-blue-600 hover:bg-blue-700 text-white font-black h-16 rounded-[1.25rem] shadow-2xl shadow-blue-600/20 flex items-center justify-center gap-3 transition-all hover:scale-[1.01] active:scale-[0.98] disabled:opacity-50 uppercase tracking-[0.25em] text-[12px] mt-4">
                {loading ? <Loader2 className="animate-spin" size={24} /> : 'ESTABLISH LINK'}
              </button>
            </form>
            ...
            <div className="relative my-10">
              ...
              <div className="relative flex justify-center text-[10px] uppercase font-black">
                <span className="bg-[#050b1a] px-5 text-slate-600 tracking-[0.4em]">OR AUTH VIA</span>
              </div>
            </div>
            ...
            <p className="mt-10 text-center text-slate-700 font-bold text-[10px] uppercase tracking-widest">
              Not in the empire? <button onClick={onSwitchToSignup} className="text-blue-500 font-black ml-1 hover:underline underline-offset-4">Register Identity</button>
            </p>
          </div>
        </div>
      </div>
