  ...
  return (
    <div className="fixed inset-0 z-[150] flex items-center justify-center p-0 sm:p-4 bg-black/70 backdrop-blur-md animate-fade-in overflow-hidden">
      ...
      <div className="relative w-full h-full sm:h-auto sm:max-w-5xl bg-[#020617] sm:rounded-[2.5rem] overflow-y-auto sm:overflow-hidden shadow-[0_48px_100px_-12px_rgba(0,0,0,1)] animate-scale-in border border-white/10">
        ...
        <button 
          onClick={onClose} 
          className="hidden sm:flex absolute top-8 right-8 z-20 w-12 h-12 rounded-2xl bg-white/5 border border-white/10 items-center justify-center text-white hover:bg-white/20 transition-all active:scale-90"
        >
          <X size={24} />
        </button>
        ...
        <button 
          onClick={onClose} 
          className="sm:hidden absolute top-6 right-6 z-20 w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-white/20 transition-all active:scale-90"
        >
          <X size={24} />
        </button>
        ...
        <div className="flex flex-col lg:flex-row h-full sm:h-auto">
          ...
          <div className="w-full lg:w-7/12 bg-[#050b1a] flex items-center justify-center p-6 sm:p-8 lg:p-20 min-h-screen sm:min-h-0">
            <div className="w-full max-w-md mx-auto">
              ...
              <div className="mb-10 text-center lg:text-left">
                <h2 className="text-4xl lg:text-5xl font-black text-white mb-3 tracking-tighter">
                  Welcome Back
                </h2>
                <p className="text-slate-500 font-bold uppercase tracking-[0.2em] text-[11px]">
                  Access your elite workspace
                </p>
              </div>

              {error && (
                <div className="mb-8 p-5 rounded-2xl bg-red-500/10 border border-red-500/20 text-red-400 text-[11px] font-black uppercase tracking-widest animate-shake">
                  {error}
                </div>
              )}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label className="block text-[10px] font-black uppercase tracking-widest text-slate-600 mb-2 ml-1">
                    Identity Key (Email)
                  </label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full h-14 sm:h-14 bg-[#0a1121] border border-white/5 rounded-xl pl-12 pr-4 text-white focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all text-sm placeholder:text-slate-700"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full h-14 sm:h-14 bg-[#0a1121] border border-white/5 rounded-xl pl-12 pr-12 text-white focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all text-sm placeholder:text-slate-700"
                      placeholder="••••••••"
                    />
                    <button
                      type="button"
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white font-black h-14 sm:h-14 rounded-xl shadow-2xl shadow-blue-600/20 flex items-center justify-center gap-3 transition-all active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed uppercase tracking-[0.2em] text-xs mt-6"
                >
                  {loading ? (
              ...
              <div className="relative my-8">
                ...
                <div className="relative flex justify-center text-[10px] uppercase font-black">
                  <span className="bg-[#050b1a] px-5 text-slate-600 tracking-[0.2em]">OR</span>
                </div>
              </div>

              <button
                onClick={handleGoogleLogin}
                className="w-full bg-[#0a1121] border border-white/5 h-14 rounded-xl flex items-center justify-center gap-4 font-bold text-white hover:bg-[#0f172a] transition-all text-xs uppercase tracking-wider"
              >
              ...
              <p className="mt-10 text-center text-slate-600 font-bold text-[11px] uppercase tracking-widest pb-6 lg:pb-0">
                Not in the system?{' '}
                <button
